...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1585894482, 1697223, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xb47ce9a8d701dfab451c55687a6b3b0865a32883068fc8d49803f87d3455d405"));
        ...
        vSeeds.emplace_back("seed-a.robreadcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.robreadcointools.com");
        vSeeds.emplace_back("dnsseed.robreadcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.robreadcointools.com");
        vSeeds.emplace_back("seed-b.robreadcoin.loshan.co.uk");
