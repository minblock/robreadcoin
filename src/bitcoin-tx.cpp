...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " robreadcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  robreadcoin-tx [options] <hex-tx> [commands]  Update hex-encoded robreadcoin transaction\n" +
            "or:     robreadcoin-tx [options] -create [commands]   Create hex-encoded robreadcoin transaction\n" +
            "\n";
