# Support for Output Descriptors in RoBreadCoin Core

Since RoBreadCoin Core v0.17, there is support for Output Descriptors. This is a
...
on RoBreadCoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing RoBreadCoin Core wallets, a convenience function `combo` is
