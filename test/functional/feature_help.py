...
"""Verify that starting robreadcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start robreadcoin with -h for help text")
        ...
        self.log.info("Start robreadcoin with -version for version information")
        ...
        self.log.info("Start robreadcoind with -fakearg to make sure it does not start")
